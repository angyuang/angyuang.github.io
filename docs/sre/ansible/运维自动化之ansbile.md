...
```
### Ansible工作原理
![image-20251222150458424](../images/image-20251222150458424.png)
...
```
### playbook图解
![image-20251222150525092](../images/image-20251222150525092.png)
```shell
...
### 三种常见的数据交换格式
![image-20251222150536093](../images/image-20251222150536093.png)
...
- hosts: srv120
  ...
  tasks:
    - name:
      ...
      when: ansible_distribution_major_version == "7"
```
![image-20251222150636716](../images/image-20251222150636716.png)
### 迭代：with_items
```shell
...
### Ansible Roles目录编排
![image-20251222150702081](../images/image-20251222150702081.png)
...
### Roles案例
Roles目录编排    
![image-20251222150726263](../images/image-20251222150726263.png)

Playbook中调用     
![image-20251222150735793](../images/image-20251222150735793.png)
